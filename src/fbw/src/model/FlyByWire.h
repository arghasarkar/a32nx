...
class FlyByWireModelClass {
 public:
  ...
  } rtDW_TimeSinceCondition_FlyByWire_T;
  ...
  typedef struct {
    ...
    rtDW_TimeSinceCondition_FlyByWire_T sf_TimeSinceCondition_m;
    rtDW_TimeSinceCondition_FlyByWire_T sf_TimeSinceCondition;
  } D_Work_FlyByWire_T;
  ...
  struct Parameters_FlyByWire_T {
    ...
    real_T DiscreteDerivativeVariableTs_Gain_h;
    ...
    real_T RateLimiterDynamicVariableTs_InitialCondition_n;
    ...
    real_T DiscreteTimeIntegratorVariableTs_UpperLimit_cf;
    ...
    real_T RateLimiterVariableTs_lo_fm;
    ...
    real_T Gain2_Gain_n;
    real_T Constant1_Value_p[9];
    real_T Constant_Value_f[9];
    ...
    real_T Gain1_Gain_a;
    real_T Gain5_Gain_m;
    real_T Delay_InitialCondition_ds;
    real_T Constant_Value_jf;
    real_T Delay1_InitialCondition_mn;
    real_T Gain4_Gain_g;
    real_T Gain6_Gain_f;
 ...
 private:
  ...
  static void FlyByWire_TimeSinceCondition(real_T rtu_time, boolean_T rtu_condition, real_T *rty_y,
